    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Pedido Entregado</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="./Vistaventas.php">Ventas</a></li>
                            <li class="breadcrumb-item active">Pedido Entregado</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                <style>
            ...
            <form action="modulos/Update_Pedido.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="selectEstatus" id="selectEstatus" class="form-control custom-select" disabled="true">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea disabled="true" name="inputComent" id="inputComent" class="form-control" rows="4"><?php echo $comentarioC; ?></textarea>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 boton-regre">
                                <a href="./Vistaventas.php" class="btn btn-secondary ancho">Regresar</a>
                            </div>
                        </div>
